...
with demo:
    ...
    with game_tabs:
        ...
        sub_tab = gr.Tab('五子棋11111', id=1)
        with sub_tab:
                gr.Markdown('# <center> \N{fire} Powered by Agentscope1111</center>')
                with gr.Row(elem_classes='container'):
                    with gr.Column(scale=4):
                        with gr.Column():
                            user_chatbot1 = Chatbot(
                                value=[[None, '系统指挥官提示：您好，欢迎来到五子棋对战11111，如果你准备好了，请回答开始']],
                    ...
                    with gr.Column(scale=1):
                        user_chat_bot_cover1 = gr.HTML('<div class="bot_cover">'
    ...
    preview_send_button1.click(
        ...
        outputs=[user_chatbot1, preview_chat_input1])
