                ...
                # remind the player to make a move
                            ...
                            if is_valid_input(input):
                                ...
                                if state[uid]['board'].game_end:
                                    ...
                                    msg = Msg(name="system", content=f"{state[uid]['board_msg'].content},对手已经在棋盘下过的棋子有{str(state[uid]['gomoku_White_history'])},你已经在棋盘下过的棋子有{str(state[uid]['gomoku_Black_history'])}", role="assistant")
