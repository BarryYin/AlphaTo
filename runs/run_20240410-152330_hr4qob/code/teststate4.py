...
def send_message(chatbot, chatsys, user_input, stats,uid):
        ...
        if state[uid]['y'] ==0:
            if('开始' in user_input):
                        ...
                        host_msg = state[uid]['host_agent'](msg)
            ...
            if '开始' in user_input or  '继续' in user_input:
                        ...
                        state[uid]['y'] =state[uid]['y'] +1
                            ...
                            judge_msg = state[uid]['judge_agent'](Msg(name='judge', content=judge_content))
                            ...
                            if '7' not in judge_msg.content:
                                ...
                                parti_msg = state[uid]['parti_agent'](Msg(name='parti', content=parti_content))
                                ...
                                judge_AI_msg = state[uid]['judge_AI_agent'](Msg(name='judge', content=judge_AI_content))
            ...
            judge_msg = state[uid]['judge_AI_agent'](Msg(name='judge', content='本轮游戏结束，请将选手得分score重新初始化为5'))
